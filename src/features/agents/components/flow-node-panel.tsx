                  ...
                  <div key={step.id}>
                    ...
                    >
                      ...
                      <div className={`size-6 rounded-md flex items-center justify-center ${
                        step.type === "messageReceived" ? "bg-amber-100" :
                        ...
                        {step.type === "messageReceived" ? (
                          <Chats className="size-3.5 text-amber-600" weight="fill" />
                        ) : step.type === "chatAgent" ? (
    ...
    return (
      <div className="w-[340px] border-l border-[#E5E7EB] bg-white h-full overflow-auto">
        ...
        <div className="px-5 py-3 border-b border-[#E5E7EB]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="size-7 rounded-lg bg-amber-500 flex items-center justify-center shrink-0">
                <Chats className="size-3.5 text-white" weight="fill" />
              </div>
              <div className="min-w-0">
                <span
                ...
                <span className="text-[11px] text-[#9CA3AF]">Trigger</span>
              </div>
            </div>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
