...
export const OpenAiDialog = ({
    ...
    // Reset form values if the dialog open with new defaults
    useEffect(() => {
        if (open) {
            form.reset({
                variableName: defaultValues.variableName || "",
                            ...
                            name="systemPrompt"
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        ...
                                        <FormDescription>
                                                Sets the behavior of the assistant. Use {"{{variables}}"} for simple values or {"{{hson variable}}"} for simple values or {"{{json variable}}"} to stringify objects 
                                        </FormDescription>
                                    <FormMessage/>
                                </FormItem>
                            )}
