...
class AgentTester {
     ...
     */
    async testAgent(agentConfig, sampleInputs, expectedOutputs) {
     ...
     */
    async runTestAgent(agentConfig, input) {
        const modelMap = {
     ...
     */
    async scoreOutput(generated, expected) {
...
Respond with ONLY the JSON object, no additional text.`;
     ...
     */
    async refineAgentPrompt(originalPrompt, testResults) {
