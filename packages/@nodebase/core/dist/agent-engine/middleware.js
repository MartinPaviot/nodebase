...
exports.ProductionMiddleware = exports.DefaultMiddleware = exports.SafeModeBlockError = exports.CostLimitError = exports.LoggingMiddleware = exports.SafeModeMiddleware = exports.PiiRedactionMiddleware = exports.ContextCompressionMiddleware = exports.CostGuardMiddleware = exports.TracingMiddleware = void 0;
    ...
    handler: async (data, context) => {
        try {
            ...
            if (monthlyUsage >= monthlyLimit) {
                throw new CostLimitError(`Monthly usage limit of $${monthlyLimit} exceeded (current: $${monthlyUsage.toFixed(2)})`);
            }
        }
        catch (error) {
 ...
 */
exports.ContextCompressionMiddleware = {
 ...
 */
exports.PiiRedactionMiddleware = {
    id: 'pii_redaction',
    hook: 'after_llm',
    order: 0,
    handler: async (data, context) => {
    ...
    handler: async (data, context) => {
        if (context.safeMode) {
            ...
            if (sideEffectTools.includes(data.toolName)) {
                ...
                throw new SafeModeBlockError(`Tool ${data.toolName} blocked by Safe Mode. User confirmation required.`);
            }
        }
        return data;
    },
...
class SafeModeBlockError extends Error {
    constructor(message) {
        super(message);
        this.name = 'SafeModeBlockError';
    }
}
exports.SafeModeBlockError = SafeModeBlockError;
// ============================================================================
