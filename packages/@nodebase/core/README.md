...
Core agent engine for Nodebase, inspired by LangChain/LangSmith patterns.
...
```typescript
import { AgentRuntime, TracingMiddleware, CostGuardMiddleware } from '@nodebase/core/agent-engine';
...
```typescript
import { AutoOptimizer } from '@nodebase/core/optimization';
